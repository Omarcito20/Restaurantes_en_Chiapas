    ...
    <div class="row justify-content-center align-items-center">
      <div class="col-lg-4 col-10 order-lg-1 order-2">
        <?php
            ...
            $respuesta = file_get_contents("https://maps.googleapis.com/maps/api/directions/json?key=AIzaSyDbPXOOo9OcRaKinhJjDub-21vavOb9zYE&origin=16.912585535881615,-92.08202177644347&destination=16.2463727,-92.1344986&mode=driving");
      ...
      <div class="col-lg-6 col-10 order-lg-2 order-1">
        <iframe class="sombra" width="100%" height="450" frameborder="0" style="border:0" 
            src="https://www.google.com/maps/embed/v1/directions?key=AIzaSyDbPXOOo9OcRaKinhJjDub-21vavOb9zYE&origin=16.912585535881615,-92.08202177644347&destination=16.2463727,-92.1344986&mode=driving" allowfullscreen></iframe>
